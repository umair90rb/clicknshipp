...
import { MenuItem, Select, FormHelperText, Grid, ListItemText, InputLabel, OutlinedInput, Stack } from '@mui/material';
    ...
    >
      {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
        <CustomDialog
          ...
          visible={visible}
          onClose={onClose}
          title={`${rawMaterial ? 'Update' : 'Create'} ${type === 'raw_material' ? 'Raw Material' : 'Packaging Material'}`}
          actions={[
            {
              text: `${rawMaterial ? 'Update' : 'Create'} ${type === 'raw_material' ? 'Raw Material' : 'Packaging Material'}`,
