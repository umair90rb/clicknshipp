...
export const fetchItemDamageReport = createAsyncThunk('itemDamageReport/fetch', ({ body }, { rejectWithValue }) =>
  stockService.fetchItemDamageReport(body).catch((error) => rejectWithValue(error.response.data || error.message))
);
