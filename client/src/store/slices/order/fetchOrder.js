...
const fetchBookAllOrder = createAsyncThunk('order/bookAll/fetch', (_, { rejectWithValue }) =>
  orderService.fetchBookAllOrder().catch((error) => rejectWithValue(error.response.data || error.message))
);
